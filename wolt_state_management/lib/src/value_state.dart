...
final class IdleValueState<T> extends ValueState<T> {
  ...
  bool operator ==(Object other) =>
      ...
      other is IdleValueState<T> && runtimeType == other.runtimeType && value == other.value;

  @override
  String toString() => 'IdleValueState(value: $value)';
}
...
final class LoadingValueState<T> extends ValueState<T> {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is LoadingValueState<T> && runtimeType == other.runtimeType && value == other.value;

  @override
  String toString() => 'LoadingValueState(value: $value)';
}
...
final class ErrorValueState<T> extends ValueState<T> {
  ...
  @override
  String toString() => 'ErrorValueState(error: $error, value: $value)';
}
