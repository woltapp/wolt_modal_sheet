...
void main() {
  group('WoltStickyActionBarWrapper', () {
    group('Rendering', () {
      testWidgets(
        'should render shrunk widget when stickyActionBar is null',
        (tester) async {
      ...
      testWidgets(
        'should render stickyActionBar when provided',
        (tester) async {
    ...
    group('Gradient visibility', () {
      testWidgets(
        'should show gradient when hasSabGradient is true',
        (tester) async {
          await tester.pumpWidget(
            MaterialApp(
          ...
          await tester.pumpAndSettle();
          expect(
            find.byKey(WoltStickyActionBarWrapper.gradientWidgetKey),
            findsOneWidget,
          );
        },
      );
      ...
      testWidgets(
        'should not show gradient when hasSabGradient is false',
        (tester) async {
          await tester.pumpWidget(
            MaterialApp(
              home: WoltStickyActionBarWrapper(
