...
class StatefulValueNotifier<T> extends ValueNotifier<ValueState<T>>
  ...
  StatefulValueNotifier._([T? initialValue]) : super(ValueState.idle(value: initialValue));
  ...
  factory StatefulValueNotifier.error(Object error, [T? initialValue]) {
    return StatefulValueNotifier._()..setError(error: error, value: initialValue);
  }
  ...
  void setError({
    ...
    this.value = this.value.setError(error: error, retainValue: retainValue, value: value);
  }
}
